...
class WaterfallMoulinetteFiniteBackup(WaterfallMoulinetteFinite):
    ...
    """
    def __init__(self, test_capacity=1, ks=1, kf=1, test_time=1, result_time=1, backup_capacity=10):
    ...
    def run_test(self, user):
        ...
        if self.backup_storage.items:
            user_from_backup = self.backup_storage.get()  # FIXME: trouver comment pretty print ceci comme un Utilisateur... sûrement un probleme de contexte.
